...
const API_KEY = '17ca18530b5894ab737e4dce6ae70039'
...
const formatForecasWeather = (secs, offset, data) => {
    console.log(secs);
//hourly
...
const getFormattedWeatherData = async (searchParams) => {
    ...
    const formattedForecasWeather = await getWeatherData("forecast", {
        lat, 
        lon, 
        units: searchParams.units,
        }).then((d) => formatForecasWeather(dt, timezone, d.list)) 
